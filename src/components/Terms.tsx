  ...
  const sections = [
    {
      ...
      content: [
        ...
        '• Livrare în formatul solicitat de Client — vertical 9:16, pătrat 1:1 sau 4:5, ori orizontal 16:9 — optimizat pentru TikTok, Instagram Reels, YouTube Shorts, Facebook Ads sau alte platforme',
        ...
        '• Crop & Reframe — adaptare conținut la formatul solicitat (vertical, pătrat sau orizontal), cu reîncadrare dinamică',
