    ...
    <section id="pricing" className="py-16 md:py-24 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-20">
          <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 border-2 border-blue-200 rounded-2xl p-6 md:p-8 max-w-5xl mx-auto shadow-lg mb-6">
            ...
            Pachete de Editare Video pentru Promovarea<br className="sm:hidden" />
              <span className="block mt-1">Afacerii Tale prin Video Marketing</span>
            </h2>
          </div>
