    ...
    <section id="pricing" className="py-16 md:py-24 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-20">
          <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 border-2 border-blue-200 rounded-2xl p-4 md:p-6 max-w-5xl mx-auto shadow-lg mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent mb-3 md:mb-4 leading-tight px-2">
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-xl p-4 md:p-6 max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 leading-relaxed text-sm md:text-base font-medium">
                ...
                script personalizat și materiale video/foto stock</strong> - oferite în limita resurselor 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-700 text-xs md:text-sm font-medium">
                <li>• O revizuire gratuită în 48 de ore</li>
